<x-layout-admin>
    ...
    <div class="p-6">
        <x-back-button href="{{ route('admin.pengajuan_dana.index') }}">Kembali ke Rekap Pengajuan</x-back-button>
            ...
            @if (in_array($userJabatan, ['atasan', 'hrd', 'direktur']) && $statusSaatIni == 'menunggu')
                <div class="bg-white rounded-lg shadow p-6 mt-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <form action="{{ route('admin.pengajuan_dana.approve', $pengajuanDana->id) }}" method="POST">
                            @csrf
                        ...
                        <form action="{{ route('admin.pengajuan_dana.reject', $pengajuanDana->id) }}" method="POST">
                            @csrf
